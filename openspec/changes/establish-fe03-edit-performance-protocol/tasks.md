...
- [ ] 2.6 在 2.1–2.5 全部完成并已人工记录 `functional complete` 前，不实施、采集或运行 `fe03-edit-pf/v1` 的 descriptor、collector、measurement、comparison 或 formal closure；不得以任何功能检查点勾选 FE-03、更新 frontier 或替代后续 gate。
