...
pub fn run() {
    ...
    let builder = builder.invoke_handler(tauri::generate_handler![
        ...
        scan_native_subagents,
        discover_native_subagents,
        install_native_subagent,
        read_native_subagent,
        adopt_native_subagent,
        save_native_subagent,
        set_native_subagent_enabled,
        uninstall_native_subagent,
        backup_native_subagent,
        get_native_subagent_backups,
        delete_native_subagent_backup,
        restore_native_subagent_backup,
        check_native_subagent_updates,
        preview_native_subagent_update,
        apply_native_subagent_update,
