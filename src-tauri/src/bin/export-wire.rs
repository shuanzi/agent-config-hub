...
fn declarations() -> Vec<String> {
    ...
    vec![
        ...
        wire::SensitiveAccessScopeWire::decl(),
        wire::SensitiveWorkbenchSurfaceWire::decl(),
        ...
        wire::SensitiveRevealQueryWire::decl(),
        ...
        wire::SkillReadSurfaceWire::decl(),
        wire::LongTermInstructionReadSurfaceWire::decl(),
        wire::SubagentReadSurfaceWire::decl(),
        wire::AssetReadSurfaceWire::decl(),
        ...
        wire::MaskedSourcePartWire::decl(),
        ...
        wire::SensitiveAccessGrantWire::decl(),
        wire::SensitiveRevealSnapshotWire::decl(),
