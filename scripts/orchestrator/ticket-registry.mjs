...
export const TICKET_REGISTRY = Object.freeze({
  'FE-02': {
    ...
    fixtures: [
      { id: 'FX-02', root: 'fixtures/fx-02' },
      { id: 'FX-03', root: 'fixtures/fx-03' },
    ],
    steps: [
      {
        id: 'toolchain',
      ...
      },
      {
        ...
        cmd: 'node',
        args: ['scripts/orchestrator/test-rust.mjs', 'FE-02'],
        timeoutMs: 1_800_000,
      },
      {
        id: 'frontend-read-surfaces',
        layer: 'L1',
        ...
        args: [
          ...
          'vitest',
          'run',
          'tests/l1/fe02-tauri-read-wire.test.ts',
          'tests/l1/fe02-read-only-detail-session.test.ts',
        ],
        timeoutMs: 1_200_000,
      },
      {
        id: 'perf-read-contract',
        layer: 'L1',
        provenance: L1_FRONTEND_PROVENANCE,
        cmd: 'corepack',
        args: [
      ...
      },
      {
        ...
        args: [
          ...
          'wdio',
          'run',
          'tests/l2/wdio.conf.ts',
          '--spec',
          'tests/l2/fe02-read-surfaces.journey.test.ts',
        ],
        timeoutMs: 900_000,
      },
      {
        ...
        cmd: 'node',
        args: ['scripts/orchestrator/test-fx02-tauri.mjs'],
        timeoutMs: 2_400_000,
      },
      ...[
        {
      ...
      ].map(({ id, descriptorId, profile, evidenceRelativeDir }) => ({
        id,
        layer: 'PF',
    ...
    performances: [
      {
        ...
        frozenLabel: 'budget-frozen（performance/budgets/pf-02.representative.budgets.json）',
      },
      {
        descriptorId: 'PF-02',
        profile: 'stress',
      ...
      },
      {
        ...
        unfrozenLabel:
          'baseline-collected / budget-not-frozen / inconclusive（首次完整 clean profile 只收集样本，不产生 closure）',
        frozenLabel: 'budget-frozen（performance/budgets/pf-03.representative.budgets.json）',
      },
      {
        descriptorId: 'PF-03',
        profile: 'stress',
        ...
        unfrozenLabel:
          'baseline-collected / budget-not-frozen / inconclusive（首次完整 clean profile 只收集样本，不产生 closure）',
        frozenLabel: 'budget-frozen（performance/budgets/pf-03.stress.budgets.json）',
      },
    ],
    artifact: {
    ...
    uncoveredBoundaries: [
      'PF-02/PF-03 仅为 L2 Vite dev/mock 的 synthetic read performance profiles',
      '不证明 reference-Mac、release-like 或 production artifact',
      '不包含 Hook、write、draft、prepare、apply 或 L3 write/PF credit',
      'L3 仅为隔离 FX-02 actual multi-file read，独立于 PF synthetic evidence',
    ],
